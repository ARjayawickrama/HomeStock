          ...
          >
            {[
              ...
              },
              {
                ...
                desc: "Connect compatible IoT sensors to monitor storage conditions for temperature-sensitive items.",
                color: "from-red-500 to-red-600",
              },
              {
                icon: <FaBarcode className="text-4xl" />,
                title: "Barcode Scanning",
                desc: "Quickly add and manage items using built-in barcode scanning for faster input.",
